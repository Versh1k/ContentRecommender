...
public class MoodAnalysisService : IMoodAnalysisService
{
    ...
    private void LoadModel()
    {
        try
        {
            ...
            {
            Path.Combine(_env.ContentRootPath, "ML", "Models", "MoodAnalyzer.zip"),
            Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ML", "Models", "MoodAnalyzer.zip"),
            Path.Combine(Directory.GetCurrentDirectory(), "ML", "Models", "MoodAnalyzer.zip")
        };
